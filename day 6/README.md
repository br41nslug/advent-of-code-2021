...
## Running it
For this one i used the .net 6.0 sdk.
I'm only leaving part 2 in a working state as it solves part 1 too just a lot more optimized for big numbers!

- Running: `dotnet run 3,4,3,1,2 80`
- Running: `dotnet run 3,4,3,1,2 256`